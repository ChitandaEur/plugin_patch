...
{
    choice=$(zen_nospam --list --title="SteamOS工具箱" --text="脚本版本:2.5.3\n有bug请联系QQ群：945280107，有想加的功能请联系QQ群：945280107\n请选择一个选项:" \
        --column="编号" --column="功能" \
        1 "初始化国内软件源" \
        2 "安装UU加速插件" \
        3 "安装讯游加速插件" \
...
[archlinuxcn]" | sudo tee /etc/pacman.conf > /dev/null
        ...
        6)
            ...
            case $steamcommunity302_choice in
                1)
                    zen_nospam --info --text="开始安装steamcommunity302..." --width=200 --height=100
                ...
                2)
                    SCRIPT_ABSOLUTE_PATH__302=$(readlink -f "$0")
                    SCRIPT_DIRECTORY_plugin_patch=$(dirname "$SCRIPT_ABSOLUTE_PATH__302")
                    zen_nospam --info --text="重新安装steamcommunity302...\n开始卸载旧版本..." --width=300 --height=100
                    sleep 1
                    cd /home/deck/.local/share/SteamDeck_302/
                    chmod +x /home/deck/.local/share/SteamDeck_302/uninstall.sh
                    sh /home/deck/.local/share/SteamDeck_302/uninstall.sh
                    cd "$SCRIPT_DIRECTORY_plugin_patch"
                    zen_nospam --info --text="开始安装新版本..." --width=200 --height=100
                    sleep 1
                    rm -rf /home/deck/.local/share/SteamDeck_302
                    wget -q https://vip.123pan.cn/1824872873/releases/steamcommunity302/302 -O /home/deck/Downloads/302.zip
                    unzip /home/deck/Downloads/302.zip -d /home/deck/.local/share/
                    ...
                    ;;
                *)
                    zen_nospam --error --text="请选择正确的选项！" --width=200 --height=100
                    select_main
                    ;;
            esac
            ;;
...
EOM
            ...
            zen_nospam --info --text="安装完成！按任意键返回主菜单" --width=250 --height=100
            select_main
            ;;
        9)
...
EOM
        ...
        10)
            ...
            ;;
        11)
            plugin_install_choice=$(zen_nospam --question --text="是否已经安装插件商店？" --ok-label="是" --cancel-label="否" --width=200 --height=100)
            if [ $? -eq 0 ]; then
                zen_nospam --info --text="正在开始汉化插件..." --width=200 --height=100
                ...
                zen_nospam --info --text="汉化完毕！按任意键返回主菜单" --width=200 --height=100
                select_main
            else
                zen_nospam --error --text="请先安装插件商店后再选择汉化！" --width=200 --height=100
                select_main
            fi
            ;;
        12)
...
Version=4.7.2.0" > /home/deck/.local/share/applications/Todesk.desktop
        ...
        13)
            ...
            ;;
        14)
            zen_nospam --info --text="开始安装rustdesk..." --width=200 --height=100
...
Version=1.2.7" > /home/deck/.local/share/applications/rustdesk.desktop
        ...
        25)
            ...
            if [ $? -eq 0 ]; then
                zen_nospam --info --text="正在开始安装$flathub_name..." --width=200 --height=100
                ...
                zen_nospam --info --text="安装并汉化完毕！" --width=200 --height=100
                # 查找 .desktop 文件路径
                ...
                if [ -n "$desktop_file_path" ]; then
                    ...
                    zen_nospam --info --text="桌面快捷方式创建成功！" --width=200 --height=100
                else
                    zen_nospam --error --text="未找到 .desktop 文件，无法创建桌面快捷方式。" --width=200 --height=100
                fi
                zen_nospam --info --text="按任意键返回主菜单" --width=200 --height=100
                select_main
            else
                zen_nospam --error --text="请先选择初始化国内软件源后再选择安装$flathub_name！" --width=200 --height=100
                select_main
            fi
            ;;
        26)
            source_run=$(zen_nospam --question --text="是否已经初始化国内软件源？" --ok-label="是" --cancel-label="否")
            if [ $? -eq 0 ]; then
                zen_nospam --info --text="正在开始安装基于HMCL启动器的Minecraft..." --width=200 --height=100
                steamos-readonly disable
...
Version=Early_Access_4176" > /home/deck/.local/share/applications/yuzu.desktop
            ...
            ;;
        28)
            zen_nospam --info --text="开始安装模拟器体感陀螺仪插件，版本 V2.2.1 ..." --width=200 --height=100
            sleep 1
...
Keywords=hulu;宝葫芦;葫芦" > /home/deck/.local/share/applications/hulu.desktop
        ...
        30)
            ...
            if [ $? -eq 0 ]; then
                zen_nospam --info --text="开始安装Waydroid..." --width=200 --height=100
                sleep 1
...
Type=Application" > /home/deck/Desktop/Waydroid.desktop
                ...
                zen_nospam --error --text="请开启魔法后再选择安装Waydroid！" --width=200 --height=100
                select_main
            fi
            ;;
        31)
...
Version=3" > /home/deck/.local/share/applications/Watt\ Toolkit.desktop
        ...
        32)
            ...
            eval "$VERSION_INFO"
            zen_nospam --info --text="正在下载安装包..." --width=200 --height=100
            ...
            zen_nospam --info --text="下载完成，正在解压..." --width=200 --height=100
...
function flatpak_install()
{
    ...
    if [ $? -eq 0 ]; then
        zen_nospam --info --text="正在开始安装$flathub_name..." --width=200 --height=100
        flatpak install -y flathub $flatpak_name
        zen_nospam --info --text="安装完毕！" --width=200 --height=100
        # 查找 .desktop 文件路径
        desktop_file_path="/var/lib/flatpak/exports/share/applications/$flatpak_name.desktop"
        # 如果找到 .desktop 文件，复制到桌面并设置权限
        if [ -n "$desktop_file_path" ]; then
...
#仓库地址
version_url="https://gitee.com/soforeve/plugin_patch/raw/master/version/version_zen_nospam.txt"
download_url="https://vip.123pan.cn/1824872873/releases/plugin_patch_zen_nospam.sh"

#自动更新程序
new_version=$(curl -s $version_url | grep 'version_zen_nospam=' | cut -d'=' -f2)
